...
disease_keywords = {
    ...
    "RedRot": ["โรคเหี่ยวเน่าแดง", "เหี่ยวเน่าแดง", "เน่าแดง", "เหี่ยวเน่า", "เน่า", "เหี่ยว", "เน่าแดง", "เหี่ยวเน่าแดงอ้อย", "เน่าแดงอ้อย", "เหี่ยวเน่าอ้อย", "เน่าอ้อย","RedRot","redrot"],
    "Yellow": ["โรคใบไหม้", "ใบไหม้", "ไหม้","โรคใบไหม้อ้อย","Yellow","yellow","ใบไหม้อ้อย","ไหม้อ้อย"],
    "Healthy": ["อ้อยสุขภาพดี", "สุขภาพดี", "สุขภาพ", "อ้อยสุขภาพ", "Healthy","healthy","สุขภาพดีอ้อย","อ้อยสุขภาพ","ใบปกติ","ปกติ"]
}
app = FastAPI()
